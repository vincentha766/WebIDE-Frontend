        ...
        <div className='intro-feature'>
          ...
          <Tabs>
            ...
            <TabPanel>
              <div className='tab-panel'>
                <div className='tab-panel-img'>
                  <img src='/rs2/misc/5f892a55-9e72-4a2b-a834-92c883deebd0.png' alt='feature_1'/>
                </div>
            ...
            <TabPanel>
              <div className='tab-panel'>
                <div className='tab-panel-img'>
                  <img src='/rs2/misc/b0e4ce12-a4ed-4f78-b7c6-e2dcf66d32df.png' alt='feature_2'/>
                </div>
                <div className='tab-panel-intro'>
                  <h3>多人协作</h3>
            ...
            <TabPanel>
              <div className='tab-panel'>
                <div className='tab-panel-img'>
                  <img src='/rs2/misc/cfa1e9da-9246-4da6-896f-009c445fc9fa.png' alt='feature_3' />
                </div>
                <div className='tab-panel-intro'>
        ...
        <div className='intro-swiper'>
          ...
          <div className='intro-swiper-c'>
            <Swiper pagination={{
              ...
              <div>
                <img src='/rs2/misc/3c2d37c6-1e83-4811-acf2-2c779094ef53.png' alt='screen-1' />
                <div className="desc">小程序开发</div>
              </div>
              <div>
                <img src='/rs2/misc/4837bb50-5338-42e8-8f3a-a24974e6e891.png' alt='screen-2' />
